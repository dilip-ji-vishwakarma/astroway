...
export const useDataMutation = () => {
  ...
  const getData = async (page = 1, limit = 10) => {
    try {
      ...
      const res = await apiServices(`${news}?${query}`, "get");
  ...
  return {data, pagination, handlePageChange, loading, handleLimitChange, deletingId, tooglegId, handleToogle, handleDelete};
};