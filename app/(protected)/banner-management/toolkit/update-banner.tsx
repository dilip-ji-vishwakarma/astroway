...
export const UpdateBanner = ({
  ...
  const { onFormSubmit } = useBannerMutations(onOpenChange, id);
  const {
    handleSubmit,
    control,
    setValue,
  ...
  useEffect(() => {
    if (open && data) {
      setValue("bannerType", data.bannerType || "");
      setValue("fromDate", data.fromDate || null);
      setValue("toDate", data.toDate || null);
